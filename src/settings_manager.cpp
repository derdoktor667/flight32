...
const SettingsManager::SettingMetadata SettingsManager::_settings_metadata[] = {
    ...
    {SettingsManager::KEY_RC_CHANNEL_ROLL, "rc.ch.roll", "RC Roll Channel Index", SettingsManager::UINT8, nullptr, 0, 1, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_PITCH, "rc.ch.pitch", "RC Pitch Channel Index", SettingsManager::UINT8, nullptr, 0, 0, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_THRO, "rc.ch.thro", "RC Throttle Channel Index", SettingsManager::UINT8, nullptr, 0, 2, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_YAW, "rc.ch.yaw", "RC Yaw Channel Index", SettingsManager::UINT8, nullptr, 0, 3, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_ARM, "rc.ch.arm", "RC Arming Channel Index", SettingsManager::UINT8, nullptr, 0, 4, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_FMODE, "rc.ch.fmode", "RC Flight Mode Channel Index", SettingsManager::UINT8, nullptr, 0, 5, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_AUX1, "rc.ch.aux1", "RC Auxiliary Channel 1 Index", SettingsManager::UINT8, nullptr, 0, 6, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_AUX2, "rc.ch.aux2", "RC Auxiliary Channel 2 Index", SettingsManager::UINT8, nullptr, 0, 7, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_AUX3, "rc.ch.aux3", "RC Auxiliary Channel 3 Index", SettingsManager::UINT8, nullptr, 0, 8, 0.0f, nullptr},
    {SettingsManager::KEY_RC_CHANNEL_AUX4, "rc.ch.aux4", "RC Auxiliary Channel 4 Index", SettingsManager::UINT8, nullptr, 0, 9, 0.0f, nullptr},

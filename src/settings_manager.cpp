...
const SettingsManager::SettingMetadata SettingsManager::_settings_metadata[] = {
    ...
    {KEY_MOTOR_MIN_THROTTLE, "motor.min_thr", "Minimum motor throttle value", SettingsManager::FLOAT, nullptr, 0, 0, (float)MOTOR_MIN_THROTTLE_RAW, nullptr},
    {KEY_MOTOR_MAX_THROTTLE, "motor.max_thr", "Maximum motor throttle value", SettingsManager::FLOAT, nullptr, 0, 0, (float)MOTOR_MAX_THROTTLE_RAW, nullptr},
    {KEY_MOTOR_MIN_COMMAND, "motor.min_cmd", "Minimum motor command value", SettingsManager::FLOAT, nullptr, 0, 0, (float)MOTOR_MIN_THROTTLE_RAW, nullptr},

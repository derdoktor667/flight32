...
static constexpr uint8_t MSP_ATTITUDE = 108; // Changed from 100 to 108 to match Betaflight
...
static constexpr uint8_t MSP_SENSOR_STATUS = 209;            // Changed from 108 to 209 to free up 108 for MSP_ATTITUDE
